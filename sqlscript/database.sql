...
-- Inserts para la tabla 'pregunta' (15 preguntas)
-- Usaremos un id_creador cíclico del 1 al 10 y id_categoria cíclico del 1 al 10.

INSERT INTO pregunta (texto, id_categoria, id_creador, estado, veces_mostrada, veces_respondida_correctamente) VALUES
                                                                                                                   ('¿Qué país ganó la Copa Mundial de la FIFA en 2022?', 1, 1, 'activa', 0, 0), -- Deporte
                                                                                                                   ('¿En qué año cayó el Muro de Berlín?', 2, 2, 'activa', 0, 0), -- Historia
                                                                                                                   ('¿Cuál es el planeta más grande de nuestro sistema solar?', 3, 3, 'activa', 0, 0), -- Ciencia
                                                                                                                   ('¿Quién dirigió la película "Titanic"?', 4, 4, 'activa', 0, 0), -- Entretenimiento
                                                                                                                   ('¿Cuál es el río más largo del mundo?', 5, 5, 'activa', 0, 0), -- Geografía
                                                                                                                   ('¿Quién pintó la Mona Lisa?', 6, 6, 'activa', 0, 0), -- Arte
                                                                                                                   ('¿Qué significa WWW en una dirección web?', 7, 7, 'activa', 0, 0), -- Tecnología
                                                                                                                   ('¿Qué banda es conocida por la canción "Bohemian Rhapsody"?', 8, 8, 'activa', 0, 0), -- Música
                                                                                                                   ('¿Quién escribió "Cien años de soledad"?', 9, 9, 'activa', 0, 0), -- Literatura
                                                                                                                   ('¿De qué país es originaria la pizza?', 10, 10, 'activa', 0, 0), -- Gastronomía
                                                                                                                   ('¿Cuántos jugadores tiene un equipo de baloncesto en la cancha?', 1, 1, 'activa', 0, 0), -- Deporte
                                                                                                                   ('¿Quién fue el primer presidente de los Estados Unidos?', 2, 2, 'activa', 0, 0), -- Historia
                                                                                                                   ('¿Cuál es el principal gas responsable del efecto invernadero en la Tierra?', 3, 3, 'activa', 0, 0), -- Ciencia
                                                                                                                   ('¿Quién interpreta a Iron Man en el Universo Cinematográfico de Marvel?', 4, 4, 'activa', 0, 0), -- Entretenimiento
                                                                                                                   ('¿Cuál es la montaña más alta del mundo?', 5, 5, 'activa', 0, 0); -- Geografía

-- Inserts para la tabla 'respuesta' (4 respuestas por cada pregunta)
-- Asumiendo que los IDs de las preguntas se generaron secuencialmente del 1 al 15.

-- Respuestas para Pregunta 1: ¿Qué país ganó la Copa Mundial de la FIFA en 2022? (id_pregunta: 1)
...
-- Respuestas para Pregunta 2: ¿En qué año cayó el Muro de Berlín? (id_pregunta: 2)
INSERT INTO respuesta (id_pregunta, texto, es_correcta) VALUES
                                                            (2, '1989', TRUE),
                                                            (2, '1991', FALSE),
                                                            (2, '1985', FALSE),
...
-- Respuestas para Pregunta 3: ¿Cuál es el planeta más grande de nuestro sistema solar? (id_pregunta: 3)
INSERT INTO respuesta (id_pregunta, texto, es_correcta) VALUES
                                                            (3, 'Júpiter', TRUE),
                                                            (3, 'Marte', FALSE),
                                                            (3, 'Saturno', FALSE),
...
-- Respuestas para Pregunta 4: ¿Quién dirigió la película "Titanic"? (id_pregunta: 4)
INSERT INTO respuesta (id_pregunta, texto, es_correcta) VALUES
                                                            (4, 'James Cameron', TRUE),
                                                            (4, 'Steven Spielberg', FALSE),
                                                            (4, 'Christopher Nolan', FALSE),
                                                            (4, 'Martin Scorsese', FALSE);

-- Respuestas para Pregunta 5: ¿Cuál es el río más largo del mundo? (id_pregunta: 5)
INSERT INTO respuesta (id_pregunta, texto, es_correcta) VALUES
                                                            (5, 'Amazonas', TRUE),
                                                            (5, 'Nilo', FALSE),
                                                            (5, 'Mississippi', FALSE),
...
-- Respuestas para Pregunta 6: ¿Quién pintó la Mona Lisa? (id_pregunta: 6)
INSERT INTO respuesta (id_pregunta, texto, es_correcta) VALUES
                                                            (6, 'Leonardo da Vinci', TRUE),
                                                            (6, 'Vincent van Gogh', FALSE),
                                                            (6, 'Pablo Picasso', FALSE),
                                                            (6, 'Claude Monet', FALSE);

-- Respuestas para Pregunta 7: ¿Qué significa WWW en una dirección web? (id_pregunta: 7)
INSERT INTO respuesta (id_pregunta, texto, es_correcta) VALUES
                                                            (7, 'World Wide Web', TRUE),
                                                            (7, 'World Wide Wonder', FALSE),
                                                            (7, 'Western World Web', FALSE),
                                                            (7, 'World Wide Wisdom', FALSE);

-- Respuestas para Pregunta 8: ¿Qué banda es conocida por la canción "Bohemian Rhapsody"? (id_pregunta: 8)
INSERT INTO respuesta (id_pregunta, texto, es_correcta) VALUES
                                                            (8, 'Queen', TRUE),
                                                            (8, 'The Beatles', FALSE),
                                                            (8, 'Led Zeppelin', FALSE),
                                                            (8, 'Pink Floyd', FALSE);

-- Respuestas para Pregunta 9: ¿Quién escribió "Cien años de soledad"? (id_pregunta: 9)
INSERT INTO respuesta (id_pregunta, texto, es_correcta) VALUES
                                                            (9, 'Gabriel García Márquez', TRUE),
                                                            (9, 'Mario Vargas Llosa', FALSE),
                                                            (9, 'Jorge Luis Borges', FALSE),
                                                            (9, 'Julio Cortázar', FALSE);

-- Respuestas para Pregunta 10: ¿De qué país es originaria la pizza? (id_pregunta: 10)
INSERT INTO respuesta (id_pregunta, texto, es_correcta) VALUES
                                                            (10, 'Italia', TRUE),
                                                            (10, 'Francia', FALSE),
                                                            (10, 'España', FALSE),
...
-- Respuestas para Pregunta 11: ¿Cuántos jugadores tiene un equipo de baloncesto en la cancha? (id_pregunta: 11)
INSERT INTO respuesta (id_pregunta, texto, es_correcta) VALUES
                                                            (11, '5', TRUE),
                                                            (11, '6', FALSE),
                                                            (11, '7', FALSE),
...
-- Respuestas para Pregunta 12: ¿Quién fue el primer presidente de los Estados Unidos? (id_pregunta: 12)
INSERT INTO respuesta (id_pregunta, texto, es_correcta) VALUES
...
-- Respuestas para Pregunta 13: ¿Cuál es el principal gas responsable del efecto invernadero en la Tierra? (id_pregunta: 13)
INSERT INTO respuesta (id_pregunta, texto, es_correcta) VALUES
                                                            (13, 'Dióxido de carbono', TRUE),
                                                            (13, 'Oxígeno', FALSE),
                                                            (13, 'Nitrógeno', FALSE),
                                                            (13, 'Metano', FALSE);

-- Respuestas para Pregunta 14: ¿Quién interpreta a Iron Man en el Universo Cinematográfico de Marvel? (id_pregunta: 14)
INSERT INTO respuesta (id_pregunta, texto, es_correcta) VALUES
                                                            (14, 'Robert Downey Jr.', TRUE),
                                                            (14, 'Chris Evans', FALSE),
                                                            (14, 'Mark Ruffalo', FALSE),
                                                            (14, 'Chris Hemsworth', FALSE);

-- Respuestas para Pregunta 15: ¿Cuál es la montaña más alta del mundo? (id_pregunta: 15)
INSERT INTO respuesta (id_pregunta, texto, es_correcta) VALUES
                                                            (15, 'Monte Everest', TRUE),
                                                            (15, 'K2', FALSE),
                                                            (15, 'Kangchenjunga', FALSE),
                                                            (15, 'Lhotse', FALSE);
